...
$need_form_keys = [
    ['FIO','field24a855_3fcfcb','^[А-Яа-яЁё\s]+$'],
    ['Telefone','field259b0c_7d5bc8','^\+?[0-9]{11}$'],
    ['email','email24a855_3fcfcb','[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$'],
    ['address','text2f8a3e_72a861','^[А-Яа-яЁё\s\d\.,_-]+$'],
    ['ploshad pomesheniya','text5330ae_ff0669','^[0-9]{1,7}$'],
    ['Captcha','sup_captcha','^[a-zA-Z\d]+$'],
];
$additional_form_keys = [
    // empty
    ['comment', 'area18676c_2df63c',''],
    ['where','radiob80aed_e62942',''],
    ['how pay','radiof97feb_a91e78',''],
    ['is we deal','radiof00a6c_12e22e',''],
...
function mySendMailMessage($s,$need_form_keys,$additional_form_keys){
    ...
    $message->addPart('Заявка на дизайн проект', 'text/html');
    foreach($need_form_keys as $k => $v){
